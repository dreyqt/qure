...
const BACKGROUND_IMAGE_URL =
  'https://images.unsplash.com/photo-1610563167222-1a465658b956?auto=format&fit=crop&w=2560&q=80&sat=-20';

export function Hero() {
  return (
    <div className="relative h-[500px] flex items-center px-6">
      {/* Background Image */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full">
        <div className="bg-[#1E3A5F] text-white p-12 rounded-lg max-w-2xl">
